...
from physhik.blog.models import Contact
...
class ContactModelTest(TestCase):
    ...
    def test_form_content(self):
        ...
        self.assertEqual(
            expected_objects_in_form,
            ("Elon Musk", "elon@musk.com", "This is a message"),
        )
...
class ProjectModelTest(TestCase):
    ...
    def test_project_data(self):
        ...
        expected_object_details = (
            f"{project_details.title}",
            f"{project_details.slug}",
            f"{project_details.live_site}",
            f"{project_details.github_link}",
            f"{project_details.description}",
        )
        self.assertEqual(
            expected_object_details,
            (
                ...
                "acme",
                "www.example.com",
                "www.github.com/learnetto/eventlite",
                "Example description",
            ),
        )
