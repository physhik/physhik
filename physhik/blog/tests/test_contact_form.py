...
from physhik.blog.forms import ContactForm
...
class ContactFormTest(TestCase):
    def test_contact_form_field_labels(self):
        ...
        self.assertTrue(
            ...
            or form.fields["name"].label == "Your name",
        )
        self.assertTrue(
            form.fields["email"].label == None
            or form.fields["email"].label == "Your email",
        )
        self.assertTrue(
            form.fields["message"].label == None
            or form.fields["message"].label == "Your inquiry",
        )
